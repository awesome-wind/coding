...
public:
  ...
  void insert(Key key, Value value) { root_ = insert(root_, key, value); }
  ...
  void destory() { destory_node(root_); }
  ...
  void remove_node(Key key) { root_ = remove_node(root_, key); }
...
int main() {
  std::string filename = "/Users/wangzhang/Basic/binary_search_tree/bible.txt";
  ...
  if (FileOps::readFile(filename, words)) {
    ...
    std::cout << "BST , time: " << double(endTime - startTime) / CLOCKS_PER_SEC
              << " s." << std::endl;
    ...
    endTime = clock();
    std::cout << "SST , time: " << double(endTime - startTime) / CLOCKS_PER_SEC
              << " s." << std::endl;
  }
